...
$("#ftitle").attr ("value", "");
$("#furl").  attr ("value", "");
$("#fgroup :first").attr("selected", "selected");
}
...
$.ajax ({async: true, cache: false, data: "action=LinksAdd&sub=1", dataType: "xml", error: onLoadError, success: onLoadSuccess, timeout: 30000, type: "POST", url: "areq.php", processData: false});
