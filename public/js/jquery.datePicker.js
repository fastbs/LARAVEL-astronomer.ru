...
//								$('<a href="#" class="selecteee">aaa</a>'),
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										$('<a class="dp-nav-prev-year" href="#" title="' + $.dpText.TEXT_PREV_YEAR + '"><img src="images/control/control-double-180.png"/></a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '"><img src="images/control/control-180.png"/></a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
										$('<a class="dp-nav-next-year" href="#" title="' + $.dpText.TEXT_NEXT_YEAR + '"><img src="images/control/control-double.png"/></a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '"><img src="images/control/control.png"/></a>')
											.bind(
												'click',
												function()
												{
...
//					$('.selectee', this.context).focus();
	...
	// localisable text
	$.dpText = {
		TEXT_PREV_YEAR		:	'Год назад',
		TEXT_PREV_MONTH		:	'Месяц назад',
		TEXT_NEXT_YEAR		:	'Год вперед',
		TEXT_NEXT_MONTH		:	'Месяц вперед',
		TEXT_CLOSE			:	'Закрыть',
