...
function template_registration_form()
{
	...
	if ($context['visual_verification'])
	{
		...
		// add notCaptcha
		if (function_exists('notCaptcha_AddToRegisterForm')) {
		echo '
			<div class="title_bar">
				<h4 class="titlebg">', $txt['verification'], '</h4>
			</div>
			<div class="windowbg2">
				<span class="topslice"><span></span></span>
				<fieldset class="content">
					<div style="width:50%;float:left;"><strong>' . $txt['notcaptcha_form1'] . '</strong><br />
						<span class="smalltext">' . $txt['notcaptcha_form2'] . '
							<img src="' . $modSettings['notCaptcha']['url'] . 'vertical_sign.png" alt="^" border="0" />
						</span>
					</div>
					<div style="width:50%;display:block;padding-bottom:5px;float:right;text-align:left;" id="captchaImgDiv">';
