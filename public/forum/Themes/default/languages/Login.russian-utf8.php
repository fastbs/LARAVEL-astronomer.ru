...
$txt['admin_register_require_agreement'] = 'Требовать от пользователя принятия регистрационного соглашения';
$txt['admin_register_require_policy'] = 'Требовать от пользователя принятия политики конфиденциальности';
