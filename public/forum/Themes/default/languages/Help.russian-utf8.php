...
$helptxt['live_news'] = '<strong>Последние новости</strong><br /> В этом блоке отображаются последние новости с <a href="https://www.simplemachines.org/" target="_blank" class="new_win">www.simplemachines.org</a>. Просматривайте их время от времени для получения информации об обновлениях, новых релизах и важной информации от Simple Machines.';
...
$helptxt['allow_disableAnnounce'] = 'Это разрешит пользователям не получать уведомления о темах.<br /><br />Эта настройка должна быть включена, чтобы соответствовать правилам <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class="bbc_link">GDPR</a>.';
$helptxt['announcements_default'] = 'Это определяет, будет ли установлен флажок в форме регистрации.<br /><br />Эта настройка должна быть отключена, чтобы соответствовать правилам <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class= "bbc_link" >GDPR< / a>.';
$helptxt['notify_tokens'] = 'Если этот параметр включен, ссылка на отмену подписки в каждом уведомлении включает уникальный токен для идентификации запроса на отмену подписки как действительного. Без этого токена пользователям придется авторизоваться на форуме, прежде чем они смогут отказаться от подписки.<br /><br />Этот параметр должен быть включен, чтобы соответствовать правилам <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class= "bbc_link" >GDPR< / a>.';
...
$helptxt['cookie_no_auth_secret'] = 'Этот параметр заставляет SMF использовать более слабую форму аутентификации. Он должен быть включен только в том случае, если вам нужна обратная совместимость с модами авторизации, которые ещё не были обновлены для поддержки SMF 2.0.16 и выше.';
...
$helptxt['requireAgreement'] = 'Этот параметр должен быть включен, чтобы соответствовать правилам <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class= "bbc_link" >GDPR< / a>.';
$helptxt['requirePolicyAgreement'] = 'Этот параметр должен быть включен, чтобы соответствовать правилам <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class= "bbc_link" >GDPR< / a>.';
...
$helptxt['latest_support'] = 'Здесь отображаются некоторые проблемы или вопросы, связанные с конфигурацией вашего сервера. Не волнуйтесь, эта информация никуда не записывается и никому не предоставляется.<br /><br />Если Вы видите неизменяемую надпись&quot;Получение информации о поддержке...&quot;, это означает, что форум не может подключиться к серверу <a href="https://www.simplemachines.org/" target="_blank" class="new_win">www.simplemachines.org</a>.';
$helptxt['latest_packages'] = 'Здесь отображаются самые популярные и выборочные пакеты модификаций.<br /><br />Если пакеты не отображаются, форум не может подключиться к серверу <a href="https://www.simplemachines.org/" target="_blank" class="new_win">www.simplemachines.org</a>.';
$helptxt['latest_themes'] = 'Здесь отображаются последние и самые популярные темы оформления с сайта <a href="https://www.simplemachines.org/" target="_blank" class="new_win">www.simplemachines.org</a>.  Если темы не отображаются, форум не может подключиться к серверу <a href="https://www.simplemachines.org/" target="_blank" class="new_win">www.simplemachines.org</a>.';
