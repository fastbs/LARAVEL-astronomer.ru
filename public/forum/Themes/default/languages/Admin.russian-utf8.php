...
$txt['admin_agreement'] = 'Требовать от новых пользователей принятия регистрационного соглашения';
$txt['admin_agreement_minor_edit'] = 'Это незначительное изменение';
$txt['reset_agreement_desc'] = 'Это заставит всех пользователей перечитать и принять соглашение о регистрации для того чтобы продолжать использовать форум.';
$txt['admin_privacy_policy'] = 'Требовать от новых пользователей принятия политики конфиденциальности';
$txt['reset_privacy_policy_desc'] = 'Это заставит всех пользователей перечитать и принять политику конфиденциальности для того чтобы продолжать использовать форум.';
$txt['admin_agreement_info'] = 'Обновлено: %1$s.';
...
$txt['admin_main_welcome'] = 'Это ваш &laquo;%1$s&raquo;. Здесь можно управлять настройками и обслуживанием форума, просматривать логи, устанавливать пакеты модификаций, изменять темы оформления и многое другое.<div style="margin-top: 1ex;">При возникновении проблем, пожалуйста, посетите страницу &laquo;Поддержка и благодарности&raquo;. Если эта информация не помогла, попробуйте обратиться со своей проблемой на <a href="https://www.simplemachines.org/community/index.php" target="_blank" class="new_win">официальный форум поддержки</a>.</div>Кроме того, можно получить подсказку, нажав на значок <img src="' . $settings['images_url'] . '/helptopics.gif" alt="%2$s" title="%3$s" /> рядом с соответствующей опцией.';
...
$txt['privacy_policy_desc'] = 'Эта политика конфиденциальности описывает ваши обещания пользователям о том, как вы будете использовать их личные данные. Она отображается при регистрации, и должна быть принята до того, как пользователь сможет продолжить регистрацию.';
...
$txt['version_check_desc'] = 'Здесь отображаются текущие версии установленных файлов, а напротив &mdash; их последние версии. Если любой из этих файлов устарел, необходимо обновить его до последней версии с <a href="https://www.simplemachines.org/" target="_blank" class="new_win">www.simplemachines.org</a>.';
