...
$txt['congratulations_help'] = 'При возникновении любых проблем, связанных с работой форума, не забывайте про <a href="https://www.simplemachines.org/community/index.php" target="_blank">официальный сайт поддержки</a>.';
...
$txt['default_topic_message'] = 'Добро пожаловать на форум SimpleMachines!<br /><br />При возникновении каких-либо проблем с работой форума, пожалуйста, обращайтесь на [url=https://www.simplemachines.org/community/index.php]официальный сайт поддержки[/url].<br />Вы также можете посетить [url=https://www.simplemachines.ru/index.php]русскоязычное сообщество SMF[/url].<br /><br />Большое спасибо!<br />SimpleMachines';
...
$txt['install_settings_stats_info'] = 'Если разрешить, то это позволит Simple Machines посещать ваш сайт раз в месяц для сбора обычной статистики. Это поможет нам принять решение по оптимизации программного обеспечения. Для получения подробной информации посетите <a href="https://www.simplemachines.org/about/stats.php">информационную страницу</a>.';
...
$txt['db_settings_type_info'] = 'Обнаружено несколько поддерживаемых типов баз данных.';
...
$txt['db_sqlite_warning'] = 'Рекомендуется только для небольших, небольших по объему и/или внутрисетевых форумов. В будущих версиях это будет удалено!';
...
$txt['user_settings_username_info'] = 'Выберите имя, которое хотите использовать.<br />Его нельзя будет изменить в дальнейшем, но можно будет поменять отображаемое имя.';
...
$txt['error_mod_security'] = 'Программа установки обнаружила установленный модуль mod_security. Этот модуль будет блокировать передающиеся формой данные. SMF имеет встроенный сканер безопасности, который превосходит по возможностям этот модуль и работает намного эффективней.<br /><br /><a href="https://www.simplemachines.org/redirect/mod_security">Как отключить mod_security</a>';
$txt['error_mod_security_no_write'] = 'Программа установки обнаружила установленный модуль mod_security. Этот модуль будет блокировать передающиеся формой данные. SMF имеет встроенный сканер безопасности, который превосходит по возможностям этот модуль и работает намного эффективней.<br /><br /><a href="https://www.simplemachines.org/redirect/mod_security">Как отключить mod_security</a><br /><br />Кроме того, вы можете использовать свой FTP-клиент для установки прав 777 на файл .htaccess в корневой директории форума, а затем обновите эту страницу.';
...
$txt['error_already_installed'] = 'Программа установки обнаружила, что SMF уже установлен. Настоятельно <strong>не</strong> рекомендуется пытаться перезаписать установленный форум. Продолжение установки <strong>может привести к потере или повреждению имеющихся данных</strong>.<br /><br />Если всё-таки хотите произвести обновление, пожалуйста, посетите сайт <a href="https://www.simplemachines.org">Simple Machines</a> и загрузите последний пакет <em>обновления</em>.<br /><br />Если хотите перезаписать установленный форум, включая все данные, то рекомендуется удалить таблицы форума из существующей базы данных, удалить Settings.php и повторить попытку установки.';
$txt['error_warning_notice'] = 'Предупреждение!';
$txt['error_script_outdated'] = 'Программа установки устарела! Последняя версия SMF: %1$s, а ваша программа установки для %2$s.<br /><br />Рекомендуется посетить сайт <a href="https://www.simplemachines.org">Simple Machines</a> чтобы удостовериться, что устанавливается самая последняя версия.';
...
$txt['upgrade_error_script_js'] = 'Программа обновления не может найти script.js, либо он устарел. Убедитесь, что настройки путей для вашей темы оформления указаны правильно. Можно загрузить утилиту repair_settings для проверки настроек с сайта <a href="https://www.simplemachines.org">Simple Machines</a>';
...
$txt['upgrade_warning_out_of_date'] = 'Программа обновления устарела! Последняя версия SMF: <em id="smfVersion" style="white-space: nowrap;">??</em>, а ваша программа обновления для <em id="yourVersion" style="white-space: nowrap;">%1$s</em>.<br /><br />Рекомендуется посетить сайт <a href="https://www.simplemachines.org">Simple Machines</a>, чтобы удостовериться, что обновляетесь на последнюю версию.';
