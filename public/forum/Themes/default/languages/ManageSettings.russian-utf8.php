...
$txt['cookie_no_auth_secret'] = 'Использовать обычную аутентификацию';
...
$txt['notify_tokens'] = 'Использовать в сообщениях электронной почты ссылки отказа от подписки на основе токенов<div class="smalltext">Разрешает пользователям отписку без авторизации.</div>';
...
$txt['core_settings_item_gdpr'] = 'Соблюдение требований GDPR';
$txt['core_settings_item_gdpr_desc'] = 'Включение этой функции настроит ряд параметров на вашем форуме в соответствии с постановлением Европейского Союза — <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class="bbc_link">Общим регламентом по защите персональных данных</a>.';
$txt['core_settings_privacy_policy_warning'] = 'После включения этого параметра вы будете перенаправлены на страницу для создания политики конфиденциальности, в соответствии с требованиями GDPR.';
