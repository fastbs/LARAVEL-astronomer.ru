...
$txt['topic'] = 'Тема';
$txt['help'] = 'Помощь';
$txt['terms_and_policies'] = 'Условия и политика';
...
$txt['notifyboard_subscribed'] = '%1$s был подписан на уведомления о новых темах в этом разделе.';
$txt['notifyboard_unsubscribed'] = '%1$s был отписан от уведомлений о новых темах в этом разделе.';

$txt['notifytopic_subscribed'] = '%1$s был подписан на уведомления о новых ответах в этой теме.';
$txt['notifytopic_unsubscribed'] = '%1$s был отписан от уведомлений о новых ответах в этой теме.';

$txt['notify_announcements'] = 'Разрешить администраторам отправлять мне важные новости по электронной почте';
$txt['notifyannouncements_prompt'] = 'Хотите получать новостные рассылки форума, объявления и важные уведомления по электронной почте?';
$txt['notifyannouncements_subscribed'] = '%1$s был подписан на рассылку новостей форума, объявления и важные уведомления.';
$txt['notifyannouncements_unsubscribed'] = '%1$s был отписан от рассылок форума, объявлений и важных уведомлений.';

$txt['unsubscribe_announcements_plain'] = 'Чтобы отказаться от подписки на новостные рассылки форума, объявления и важные уведомления, перейдите по этой ссылке:<br />%1$s';
$txt['unsubscribe_announcements_html'] = '<span style="font-size:small"><a href="%1$s">Отписаться</a> от новостных рассылок форума, объявлений и важных уведомлений.</span>';
