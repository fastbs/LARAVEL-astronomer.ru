<div class="top-bar-wrap">
    <div id="top-bar" class="mod-con">
        ...
        <div class="links">
            @if($SMF_UserInfo["id"])
                Здравствуйте, <a
                    href="/forum/index.php?action=profile;u={{ $SMF_UserInfo["id"] }}">{{ $SMF_UserInfo["name"] }}!</a>
                <br>
        ...
        <div class="search" style="clear:both">
            <form id="cref_iframe" action="/search.php">
                ...
                <input name="siteurl" type="hidden" value="astronomer.loc/index.php"><input name="ref" type="hidden"
                                                                                            value="astronomer.loc/"><input
                    name="ss" type="hidden"></form>
        ...
        <div id="navigation">
            @include('bootstrap.menuItem', ['menuTree' => $menuTree])
        </div>
    </div>
</div>
